...
#ifndef SIGNINWITHAPPLE_SWIFT_H
#define SIGNINWITHAPPLE_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="SignInWithApple",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS_NAMED("SignInWithApple")
@interface SignInWithApple : CAPPlugin <CAPBridgedPlugin>
...
@interface SignInWithApple (SWIFT_EXTENSION(SignInWithApple)) <ASAuthorizationControllerDelegate>
