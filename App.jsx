                ...
                <div style={{ background: "#F7F9F5", border: "1px solid #DDE5EE", borderRadius: 10, padding: "14px 16px", marginBottom: 16 }}>
                  ...
                  {(profilEntreprise || profilPrenom) && profilSiret && profilAdresse ? (
                    ...
                    <div style={{ fontSize: 12, color: "#854F0B" }}>
                      ⚠️ Informations incomplètes pour une facture conforme. <button type="button" style={{ ...S.linkBtn, fontSize: 12 }} onClick={() => setNav("profil")}>Compléter mon profil →</button>
                      <div style={{ marginTop: 4, color: "#8BA5C0" }}>
                        Manque : {[!profilEntreprise && !profilPrenom && "nom/entreprise", !profilSiret && "SIRET", !profilAdresse && "adresse"].filter(Boolean).join(", ")}
                      </div>
                    </div>
                  )}
                </div>
