...
export const REGLES = {
  ...
  allocationPlafondAJOfficiel: {
    ...
    source: "Article 16 des annexes 8 et 10 (convention du 15/11/2024) : maximum = 34,4 % de 1/365e du plafond annuel des contributions, soit 0,344 × 526,68 = 181,18 €. Chiffre publié tel quel par l'Unédic (Paramètres utiles, avril 2026, p. 23 : « ARE Annexes VIII et X : 181,18 € — maximum théorique du 01/01 au 31/12/2026 »). RÉSOLU le 25/08/2026 par la vérification quotidienne.",
    version: "2026.08",
    dateAppli: "2026",
    verifie: true,
    commentaire: "C'est LE chiffre publiable (guides, FAQ, chat) : formule du texte + publication Unédic concordantes. Le MOTEUR, lui, borne plus bas (voir allocationPlafondAJ) par prudence : afficher moins que le plafond théorique ne trompe personne, afficher plus que le versé trahirait (Loi X). Évolue chaque 1er janvier avec le plafond des contributions : rituel de janvier.",
  },

  allocationPlafondAJ: {
    valeur: 155.77,
    libelle: "Plafond PRUDENT du moteur (mesuré, jamais publié comme officiel)",
    source: "MESURÉ le 2026-07-27 sur le simulateur officiel France Travail (simucalcul.pole-emploi-services.fr) : l'allocation reste bloquée à 155,77 € pour un salaire de référence de 320 000, 350 000, 500 000 et 1 000 000 €, annexe 8 comme annexe 10. ⚠️ CE N'EST PAS UN CHIFFRE PUBLIÉ : aucun texte officiel ne donne 155,77 €. Voir le commentaire.",
    version: "2026.08",
    dateAppli: "2026",
    verifie: false,
    commentaire: "⚠️ VALEUR NON RÉSOLUE, RELUE À LA SOURCE LE 15/08/2026. Il existe DEUX chiffres officiels, et aucun ne vaut 155,77 € : l'Unédic publie « ARE Annexes VIII et X : 181,18 € — maximum théorique du 1er janvier au 31 décembre 2026 » (Paramètres utiles, avril 2026, page 23, PDF lu directement) ; et le guide France Travail « Intermittents du spectacle » p.11 écrit 174,80 € depuis le 01/01/2024. Le commentaire précédent affirmait que 174,80 € était « périmé » : c'était une déduction, pas un fait, et elle est fausse pour 2026 puisque l'Unédic publie plus haut encore. NOTRE 155,77 € vient d'une MESURE sur le simulateur, pas d'un texte, d'où verifie=False. ON LE CONSERVE QUAND MÊME, et c'est un choix assumé : c'est la valeur la plus BASSE des trois, donc la seule qui ne risque pas de promettre plus que ce qui sera versé (Loi X). Monter à 181,18 € ferait afficher à un artiste très bien payé une allocation supérieure à ce que le simulateur officiel calcule. MYSTÈRE RÉSOLU le 25/08/2026 : le plafond OFFICIEL est 181,18 € (art. 16 des annexes : 34,4 % de 1/365e du plafond annuel, cf. allocationPlafondAJOfficiel, verifie=True). Ce 155,77 ne reste que comme BORNE PRUDENTE DU MOTEUR : jamais publié comme plafond (ni guide, ni FAQ, ni chat). À TRANCHER sur un vrai relevé d'un allocataire au plafond ; le rituel de janvier rejoue la mesure ET met à jour l'officiel.",
  },
  ...
  allocationRetenueRetraiteComp: {
    ...
    dateAppli: "en vigueur",
    verifie: true,
    commentaire: "AJ ≤ 31,96 € : aucune retenue. Au-delà : retenue 0,93 % × SJM, EXACTE au centime sur les 14 cas du simulateur officiel (27/07/2026), y compris à 91,72 € de retenue. Quand ce qui reste dépasse 60 €, s'ajoutent CSG et CRDS, elles-mêmes écrêtées (cf. allocationCsgCrds et allocationPlancherNetCsg).",
  },

  allocationCsgCrds: {
    valeur: { csgPlein: 0.062, csgReduit: 0.038, crds: 0.005, assiette: 0.9825 },
    libelle: "CSG/CRDS sur l'allocation journalière",
    source: "Guide France Travail p.12 (taux) ; assiette 98,25 % CONFIRMÉE le 2026-07-27 contre le simulateur officiel France Travail (simucalcul.pole-emploi-services.fr), 11 cas, annexes 8 et 10, écart 0,00 €.",
    version: "2026.08",
    dateAppli: "en vigueur",
    verifie: true,
    commentaire: "Taux 6,2 % (CSG) + 0,5 % (CRDS) = 6,7 %, appliqués sur 98,25 % de l'allocation APRÈS retenue retraite complémentaire (et non avant : vérifié, 71,45 x 98,25 % x 6,7 % = 4,70 € exactement ce qu'annonce France Travail). Le résultat est ensuite ÉCRÊTÉ par allocationPlancherNetCsg : voir cette entrée.",
  },
