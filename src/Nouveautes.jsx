...
const VAGUES = [
  {
    ...
    items: [
      ...
      { qui: "ae", texte: "Un défaut de comptage que je te dois : quand tu scannais une facture au format PDF, je pouvais lire 250 € au lieu de 1 250 €. Ma façon de reconnaître un montant ne savait pas gérer les nombres écrits sans séparateur de milliers, c'est-à-dire le cas le plus courant. Si tu as scanné des factures récemment, jette un oeil à tes encaissements : un montant faux se serait glissé dans ton chiffre d'affaires, donc dans ta déclaration URSSAF." },
