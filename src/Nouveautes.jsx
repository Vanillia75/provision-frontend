...
const VAGUES = [
  {
    ...
    items: [
      ...
      { qui: "intermittent", texte: "Ta date de renouvellement remonte aussi en haut de ton cockpit tant que je ne l'ai pas. Elle était trop bas, il fallait faire défiler pour la voir." },
      { qui: "intermittent", texte: "Et je ne me tais plus sur ta date anniversaire. Je ne la demandais qu'une fois, à l'inscription, et si tu passais outre je ne la réclamais plus jamais. Elle apparaît maintenant dans ton briefing tant que je ne l'ai pas, parce que sans elle je ne peux pas te dire si tu seras à temps." },
