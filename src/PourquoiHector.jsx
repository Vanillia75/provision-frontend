    ...
    <div style={{ minHeight: "100vh", background: "#07192E", fontFamily: "'Inter', system-ui, sans-serif" }}>
      <div style={{ maxWidth: 560, margin: "0 auto", paddingBottom: 90 }}>
        ...
        <div style={{ position: "relative" }}>
          ...
          <div style={{ position: "absolute", left: 0, right: 0, bottom: 0, height: 110, background: "linear-gradient(to bottom, rgba(7,25,46,0), #07192E)", pointerEvents: "none" }} />
        ...
        <div style={{ padding: "26px 24px 0" }}>
          ...
          <p style={pStyle}>Quand tout allait bien, il partageait les victoires. Quand les journées étaient compliquées, il était simplement présent. Sans jugement. Sans rien demander.</p>
          ...
          <p style={pStyle}>C'est pour ça qu'il s'appelle H€CTOR.</p>
